...
function load_js()
{
    ...
    wp_register_script('bundlejs', get_template_directory_uri() . '/public/js/bundle.js', ['gsap'], 1.0, true);
    wp_register_script('search', get_template_directory_uri() . '/src/js/Search.js', ['jquery'], 1.0, true);
